...
# Nombre de usuario en PythonAnywhere (ajustar si es necesario)
PYTHONANYWHERE_USERNAME = "fedeegea"

# Ruta al proyecto en PythonAnywhere
...
# Para activar el simulador automático
...
2. Abre el archivo WSGI con el comando: nano /var/www/{PYTHONANYWHERE_USERNAME}_pythonanywhere_com_wsgi.py
3. Borra todo el contenido actual
4. Copia y pega el contenido mostrado arriba
5. Guarda el archivo con Ctrl+O, Enter, Ctrl+X
6. Reinicia la aplicación web desde el panel de control de PythonAnywhere
""")
print("=" * 80)
